...
## Задача
Напиши 1, если текст содержит ответ на вопрос, иначе напиши 0
...
Не придумывай новую информацию. Если информации в контексте нет, напиши, что нет информации.
...
Список специалистов:
0) Специалист по выдаче информации 
1) Специалист по формированию аналитических отчетов
2) HR специалист (по вопросам об истории компании, об адресе, о директоре)
3) Специалист по показателям компаний за указанный год
